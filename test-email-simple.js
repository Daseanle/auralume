 ...
 * 2. 运行：node test-email-simple.js
 * 3. 检查邮箱是否收到测试邮件
 */
...
const FROM_EMAIL = 'onboarding@resend.dev'; // Resend 默认测试发件人

// 测试用户数据
const testUser = {
  email: 'marshall@shopauralume.com',
  id: 'test-user-123',
  username: 'Marshall'
};
...
async function testEmailSending() {
  ...
  try {
    ...
    console.log('3. Test clicking the "Start Your Reading" button');
    console.log('');
